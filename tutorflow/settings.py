...
# Use environment variable or a fallback (only for development)
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-development-key-294983u1jnnc9u83u9iy7ye44n5')
